...
### Role
The Cart Manager handles all shopping cart operations, payment processing, and purchase flow. It uses mock payment APIs to simulate the complete checkout experience.
...
- Processes payment via mock tokenization
