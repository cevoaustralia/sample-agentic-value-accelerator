...
- **Cart & Payment** - Cart management with mock payment support
...
- **[Deployment Guide](docs/DEPLOYMENT.md)** - Complete deployment instructions, prerequisites, and troubleshooting
- **[Infrastructure README](infrastructure/README.md)** - CDK infrastructure details
- **[Frontend Mock Mode](docs/FRONTEND_MOCK_MODE.md)** - Mock payment mode documentation
