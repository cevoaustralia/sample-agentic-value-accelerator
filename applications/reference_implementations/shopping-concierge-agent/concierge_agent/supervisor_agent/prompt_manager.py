...
""",
    ...
    # - cart_manager agent - get_cart, add_to_cart, remove_from_cart, request_purchase_confirmation, confirm_purchase, send_purchase_confirmation_email, onboard_card, get_payment_config
