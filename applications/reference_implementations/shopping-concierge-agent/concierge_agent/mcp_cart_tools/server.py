...
def onboard_card(
    ...
    try:
        ...
        # Mock tokenization (replace with real payment integration)
...
@mcp.tool()
def get_payment_config(user_id: str) -> Dict[str, Any]:
    """Get payment configuration for secure card onboarding."""
    try:
        return {
            "success": True,
            "iframe_url": "",
