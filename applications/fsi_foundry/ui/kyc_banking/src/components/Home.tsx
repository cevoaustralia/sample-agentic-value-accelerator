  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div
        ...
        style={{
          bottom: '5%', left: '-5%',
          background: 'radial-gradient(circle, rgba(114, 4, 185, 0.04) 0%, transparent 70%)',
          animationDelay: '1.5s',
        }}
      />
    </div>
...
function AgentCard({ name, description, index }: { name: string; description: string; index: number }) {
  const gradients = [
    ...
    'linear-gradient(135deg, #7204B9, #D3145A)',
  ];
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-20">
            ...
            <svg viewBox="0 0 960 520" className="w-full" style={{ maxHeight: '520px' }}>
              <defs>
                <marker id="arrow-k" viewBox="0 0 10 6" refX="10" refY="3" markerWidth="8" markerHeight="6" orient="auto-start-reverse">
                  <path d="M0,0 L10,3 L0,6" fill="#FF8F00" />
                </marker>
                <filter id="glow-k">
              ...
              <rect x="30" y="20" width="120" height="70" rx="12" fill="rgba(255,143,0,0.06)" stroke="#FF8F00" strokeWidth="1" />
              ...
              <line x1="150" y1="55" x2="220" y2="55" stroke="#FF8F00" strokeWidth="1.5" markerEnd="url(#arrow-k)" />
              ...
              <line x1="280" y1="45" x2="370" y2="45" stroke="#FF8F00" strokeWidth="1.5" markerEnd="url(#arrow-k)" strokeDasharray="4,3" />
              ...
              <line x1="250" y1="90" x2="250" y2="140" stroke="#FF8F00" strokeWidth="1.5" markerEnd="url(#arrow-k)" />
              ...
              <line x1="130" y1="166" x2="250" y2="166" stroke="#FF8F00" strokeWidth="1.5" markerEnd="url(#arrow-k)" />
              ...
              <line x1="310" y1="166" x2="430" y2="166" stroke="#FF8F00" strokeWidth="1.5" markerEnd="url(#arrow-k)" />
              <text x="370" y="158" textAnchor="middle" fill="#FF8F00" fontSize="8" fontWeight="bold">async</text>
              ...
              <line x1="490" y1="166" x2="610" y2="166" stroke="#FF8F00" strokeWidth="1.5" markerEnd="url(#arrow-k)" />
              <line x1="610" y1="174" x2="490" y2="174" stroke="#FF8F00" strokeWidth="1.5" markerEnd="url(#arrow-k)" strokeDasharray="4,3" />

              {/* Row 3: AgentCore → Agents → Bedrock */}
              <line x1="460" y1="222" x2="460" y2="280" stroke="#FF8F00" strokeWidth="1.5" markerEnd="url(#arrow-k)" />

              <rect x="250" y="288" width="280" height="60" rx="12" fill="rgba(255,143,0,0.08)" stroke="#FF8F00" strokeWidth="2" filter="url(#glow-k)" />
              <image href="/aws-icons/Arch_Amazon-Bedrock-AgentCore_48.svg" x="260" y="300" width="36" height="36" />
              <text x="400" y="314" textAnchor="middle" fill="#FF8F00" fontSize="12" fontWeight="bold">AgentCore Runtime</text>
              ...
              <line x1="178" y1="318" x2="248" y2="318" stroke="#FF8F00" strokeWidth="1.5" markerEnd="url(#arrow-k)" strokeDasharray="4,3" />

              <line x1="340" y1="348" x2="320" y2="400" stroke="#FF8F00" strokeWidth="1.5" strokeDasharray="4,3" />
              <line x1="440" y1="348" x2="530" y2="400" stroke="#FF8F00" strokeWidth="1.5" strokeDasharray="4,3" />

              <rect x="220" y="405" width="170" height="32" rx="8" fill="rgba(255,143,0,0.06)" stroke="#FF8F00" strokeWidth="1" />
              <text x="305" y="425" textAnchor="middle" fill="#FF8F00" fontSize="10" fontWeight="bold">Credit Analyst</text>

              <rect x="440" y="405" width="190" height="32" rx="8" fill="rgba(114,4,185,0.06)" stroke="#7204B9" strokeWidth="1" />
              <text x="535" y="425" textAnchor="middle" fill="#7204B9" fontSize="10" fontWeight="bold">Compliance Officer</text>
              ...
              <line x1="530" y1="318" x2="778" y2="318" stroke="#FF8F00" strokeWidth="1.5" strokeDasharray="4,3" markerEnd="url(#arrow-k)" />
        ...
        <div id="pipeline" className="max-w-5xl mx-auto mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
            {[
              { num: '01', title: 'Submit Request', desc: 'Enter a Customer ID and select assessment type (Full, Credit Only, or Compliance Only). The UI sends a POST to /api/invoke via CloudFront.', color: '#FF8F00' },
              { num: '02', title: 'Credit Analysis', desc: 'AI Credit Analyst evaluates financial health, payment history, credit exposure, and transaction patterns to compute a risk score.', color: '#F05A2A' },
              { num: '03', title: 'Compliance Check', desc: 'AI Compliance Officer runs sanctions screening, PEP verification, adverse media checks, and AML/KYC regulatory compliance.', color: '#D3145A' },
              { num: '04', title: 'Decision', desc: 'Results are synthesized into APPROVE, REJECT, or ESCALATE recommendation with credit risk score, compliance status, and full audit trail.', color: '#7204B9' },
            ].map((step, i) => (
              <div
                key={step.num}
                className="card-glow animate-fade-in"
                style={{ animationDelay: `${0.1 + i * 0.12}s`, borderTop: `3px solid ${step.color}` }}
              >
                <div className="flex items-center gap-3 mb-4">
                  <span className="font-mono text-2xl font-bold" style={{ color: step.color, opacity: 0.7 }}>{step.num}</span>
        ...
        <div className="max-w-5xl mx-auto mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { label: 'Runtime', value: 'Amazon Bedrock AgentCore', detail: 'Managed container runtime for multi-agent orchestration', color: '#FF8F00' },
              { label: 'LLM', value: 'Claude Sonnet (Bedrock)', detail: 'Foundation model for financial reasoning and compliance analysis', color: '#F05A2A' },
              { label: 'Framework', value: 'LangGraph / Strands', detail: 'Agent orchestration with parallel execution support', color: '#D3145A' },
              { label: 'API Layer', value: 'API Gateway + Lambda', detail: 'Serverless async invoke pattern with proxy/worker split', color: '#7204B9' },
              { label: 'State Store', value: 'DynamoDB', detail: 'Session tracking with TTL-based automatic cleanup', color: '#191970' },
              { label: 'CDN & Hosting', value: 'CloudFront + S3', detail: 'SPA hosting with origin access control and /api routing', color: '#FF8F00' },
            ].map((item, i) => (
              <div
                key={item.label}
                className="card-glow animate-fade-in"
                style={{ animationDelay: `${0.15 + i * 0.08}s`, borderLeft: `3px solid ${item.color}` }}
              >
            ...
            <div className="flex justify-center gap-2">
              {config.input_schema.test_entities.map((id) => (
                <code
                  ...
                  style={{ background: 'rgba(255, 143, 0, 0.08)', color: 'var(--accent)', border: '1px solid rgba(255, 143, 0, 0.2)' }}
                >
                  {id}
                </code>
              ))}
