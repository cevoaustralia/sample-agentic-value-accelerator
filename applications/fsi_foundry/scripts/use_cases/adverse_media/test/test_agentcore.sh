#!/bin/bash
# ============================================================================
# Adverse Media - Comprehensive AgentCore E2E Tests
# ============================================================================
set +e
USE_CASE_ID="${1:-adverse_media}"; FRAMEWORK="${FRAMEWORK:-langchain_langgraph}"; AWS_REGION="${AWS_REGION:-us-east-1}"
...
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}Adverse Media - AgentCore E2E Tests${NC}"
