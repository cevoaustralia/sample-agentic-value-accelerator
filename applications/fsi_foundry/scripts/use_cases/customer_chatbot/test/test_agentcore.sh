#!/bin/bash
# ============================================================================
# Customer Chatbot - Comprehensive AgentCore E2E Tests
# ============================================================================
set +e
USE_CASE_ID="${1:-customer_chatbot}"; FRAMEWORK="${FRAMEWORK:-langchain_langgraph}"; AWS_REGION="${AWS_REGION:-us-east-1}"
...
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}Customer Chatbot - AgentCore E2E Tests${NC}"
