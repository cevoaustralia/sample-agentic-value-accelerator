...
Comprehensive data analytics assessment for capital markets.
...
if AGENT_FRAMEWORK == "strands":
    from strands.orchestrator import run_data_analytics
    from strands.models import AnalyticsRequest, AnalyticsResponse

    register_agent("data_analytics", RegisteredAgent(
        entry_point=run_data_analytics,
        request_model=AnalyticsRequest,
        response_model=AnalyticsResponse,
    ))
else:
    from langchain_langgraph.orchestrator import run_data_analytics
