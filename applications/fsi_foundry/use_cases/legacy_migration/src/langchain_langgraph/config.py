...
class LegacyMigrationSettings(Settings):
    ...
    code_analyzer_model: str = "us.anthropic.claude-haiku-4-5-20251001-v1:0"
    migration_planner_model: str = "us.anthropic.claude-haiku-4-5-20251001-v1:0"
    conversion_agent_model: str = "us.anthropic.claude-haiku-4-5-20251001-v1:0"
