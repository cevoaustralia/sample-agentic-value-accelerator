...
class FraudDetectionSettings(Settings):
    ...
    transaction_monitor_model: str = "us.anthropic.claude-haiku-4-5-20251001-v1:0"
    pattern_analyst_model: str = "us.anthropic.claude-haiku-4-5-20251001-v1:0"
    alert_generator_model: str = "us.anthropic.claude-haiku-4-5-20251001-v1:0"
