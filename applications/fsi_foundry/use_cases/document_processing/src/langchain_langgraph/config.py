...
class DocumentProcessingSettings(Settings):
    ...
    document_classifier_model: str = "us.anthropic.claude-sonnet-4-20250514-v1:0"
    data_extractor_model: str = "us.anthropic.claude-sonnet-4-20250514-v1:0"
    validation_agent_model: str = "us.anthropic.claude-sonnet-4-20250514-v1:0"
