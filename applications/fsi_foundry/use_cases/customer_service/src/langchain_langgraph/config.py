...
class CustomerServiceSettings(Settings):
    ...
    # Agent configuration
    inquiry_handler_model: str = "us.anthropic.claude-sonnet-4-20250514-v1:0"
    transaction_specialist_model: str = "us.anthropic.claude-sonnet-4-20250514-v1:0"
    product_advisor_model: str = "us.anthropic.claude-sonnet-4-20250514-v1:0"
