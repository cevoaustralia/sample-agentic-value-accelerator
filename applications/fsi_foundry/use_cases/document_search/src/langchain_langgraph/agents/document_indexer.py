...
class DocumentIndexer(LangGraphAgent):
    """Document Indexer using LangGraphAgent base class."""
...
async def index_documents(query: str, context: str | None = None) -> dict:
    ...
    """
    from use_cases.document_search.config import get_document_search_settings
