...
output "langfuse_host" {
  description = "Host address of Langfuse (CloudFront HTTPS endpoint)"
  value = "https://${aws_cloudfront_distribution.langfuse.domain_name}"
}

output "cloudfront_distribution_id" {
  description = "CloudFront distribution ID for Langfuse"
  value = aws_cloudfront_distribution.langfuse.id
}

output "cloudfront_domain_name" {
  description = "CloudFront domain name for Langfuse"
  value = aws_cloudfront_distribution.langfuse.domain_name
}